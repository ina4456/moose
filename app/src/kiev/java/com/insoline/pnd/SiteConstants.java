...
public class SiteConstants {
	public static final String PROJECT_NAME = "Kiev";
	public static final int APP_VERSION = 400;
	public static final int LIMIT_LENGTH_CAR_NUMBER = 4;

	// 빈차등, 미터기 연동 정보
	public static final String SERIAL_PORT_VACANCYLIGHT = "ttyUSB1";
	public static final String SERIAL_PORT_TACHOMETER = "ttyUSB0";
